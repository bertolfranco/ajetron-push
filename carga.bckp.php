        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="antiguo/push_texto.xlsx" download>Descargar push_texto.xlsx</a>
                    </li>

                    <!-- Agrega el nuevo enlace para descargar el archivo -->
                    <li class="nav-item">
                        <a class="nav-link" href="antiguo/push_imagen.xlsx" download>Descargar push_imagen.xlsx</a>
                    </li>

                    <!-- Agrega el nuevo enlace para descargar el archivo -->
                    <li class="nav-item">
                        <a class="nav-link" href="antiguo/push_pdf.xlsx" download>Descargar push_pdf.xlsx</a>
                    </li>
            ...
            <div class="outer-container">
                <form action="" method="post" name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data">
                    <div>
                        ...
                        <a href="antiguo/texto.php" class="btn btn-primary">Enviar texto</a>
                        <a href="antiguo/imagen.php" class="btn btn-primary">Enviar imagen</a>
                        <a href="antiguo/pdf.php" class="btn btn-primary">Enviar PDF</a>
