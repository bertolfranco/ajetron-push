...
if (isset($_POST["delete"])) {
    $query = "DELETE FROM ajelover_usuarios WHERE pais = '".$paisSession."'";
...
//  $handle = str_replace(',',';',$handle);
        while (($data = fgetcsv($handle, 100000, $selectedDelimiter)) !== FALSE) {
            ...
            $q = "INSERT INTO ajelover_usuarios (pais,cod_usuario,nombre,estado) VALUES (
            '$data[0]',
            '$data[1]',
            '$data[2]',
            '$data[3]'
...
<head>
    ...
    <title>Rutalovers Carga Usuarios</title>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-12 col-md-12">
                        ...
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="assets/1_plantilla_rutalover.csv">Usuarios Rutalover</a></li>
                                </ul>
                            </div>
                        </div>
            ...
            <?php
            $sqlSelect = "SELECT * FROM ajelover_usuarios";
