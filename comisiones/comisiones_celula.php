...
if (isset($_POST["delete"])) {
    $query = "DELETE FROM comisiones_celula WHERE pais = '".$paisSession."'";
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link active" href="comisiones_celula.php">
                            Comisiones Celula
                        </a>
                    </li>
                    <li class="nav-item active">
					...
					<li class="nav-item active">
                        <a class="nav-link" href="comisiones_diashabiles.php">
...
<div class="container">
    ...
    <div class="row">
        <div class="col-12 col-md-12">
            ...
            <?php
            $sqlSelect = "SELECT * FROM comisiones_celula where pais = '".$paisSession."'";
