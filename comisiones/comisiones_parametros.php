...
if (isset($_POST["delete"])) {
    $query = "DELETE FROM parametros_configuracion WHERE pais = '".$paisSession."'";
...
<div class="container">
    <div class="row align-items-start text-center">
        <div class="col">
            <h3 class="mt-3">Carga Plantilla Parametros</h3>
        </div>
        <div class="col">
    ...
    <div class="row">
        <div class="col-12 col-md-12">
                        ...
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="static/17_plantilla_parametros_configuracion.csv">Parametros</a></li>
                                </ul>
                            </div>
                        </div>
            ...
            <?php
            $sqlSelect = "SELECT * FROM parametros_configuracion where pais = '".$paisSession."' ORDER BY ruta";
