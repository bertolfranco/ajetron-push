...
if (isset($_POST["delete"])) {
    $query = "DELETE FROM compañias_comisional_econored WHERE pais = '".$paisSession."'";
...
//  $handle = str_replace(',',';',$handle);
        while (($data = fgetcsv($handle, 100000, $selectedDelimiter)) !== FALSE) {
            ...
            if (!$firstRowSkipped) {
             ...
             $q = "INSERT INTO compañias_comisional_econored (pais,compania) VALUES (
                                        '$data[0]',
                                        '$data[1]'
                                        )";
...
<div class="container">
    <div class="row align-items-start text-center">
        <div class="col">
            <h3 class="mt-3">Carga Plantilla Compañias habilitadas para Comisiones</h3>
        </div>
        <div class="col">
    ...
    <div class="row">
        <div class="col-12 col-md-12">
                        ...
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="static/22_plantilla_compañias_comisional.csv">Vendedores sin comisiones</a></li>
                                </ul>
                            </div>
                        </div>
            ...
            <?php
            $sqlSelect = "SELECT * FROM compañias_comisional_econored where pais = '".$paisSession."'";
