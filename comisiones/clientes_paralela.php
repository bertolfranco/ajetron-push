...
$active = "clientesparalela";
// conexión

if (isset($_POST["delete"])) {
    $query = "DELETE FROM clientes_paralela WHERE pais = '" . $paisSession . "'";
...
if (isset($_POST['enviar'])) {
    ...
    if ($extension == 'csv') {
        ...
        while (($data = fgetcsv($handle, 100000, $selectedDelimiter)) !== FALSE) {
            ...
            $q = "INSERT INTO clientes_paralela (pais,cod_compania,cod_ruta,cod_cliente) VALUES (
                        '$data[0]',
                        '$data[1]',
                        '$data[2]',
                        '$data[3]',
...
<body>
    ...
    <div class="container">
        <div class="row align-items-start text-center">
            <div class="col">
                <h3 class="mt-3">Carga Plantilla Clientes Paralela</h3>
            </div>
            <div class="col">
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                            ...
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="static/20_plantilla_clientes_paralela.csv">Clientes Paralela</a></li>
                                    </ul>
                                </div>
                            </div>
                ...
                <?php
                $sqlSelect = "SELECT * FROM clientes_paralela where pais = '" . $paisSession . "' ORDER BY cod_ruta";
