...
$active = "clientesprograma";
// conexión

if (isset($_POST["delete"])) {
    $query = "DELETE FROM clientes_programa WHERE pais = '".$paisSession."'";
...
//  $handle = str_replace(',',';',$handle);
        while (($data = fgetcsv($handle, 100000, $selectedDelimiter)) !== FALSE) {
            ...
            if (!$firstRowSkipped) {
              ...
              $q = "INSERT INTO clientes_programa (pais,cod_ruta,cod_cliente,programa) VALUES (
                            '$data[0]',
                            '$data[1]',
                            '$data[2]',
                            '$data[3]'
...
<div class="container">
    <div class="row align-items-start text-center">
        <div class="col">
            <h3 class="mt-3">Carga Plantilla Clientes Programa</h3>
        </div>
        <div class="col">
    ...
    <div class="row">
        <div class="col-12 col-md-12">
            ...
            <?php
            $sqlSelect = "SELECT * FROM clientes_programa where pais = '".$paisSession."'";
