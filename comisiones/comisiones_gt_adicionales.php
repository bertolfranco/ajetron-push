...
if (isset($_POST["delete"])) {
    $query = "DELETE FROM comisiones_adicional WHERE pais = '".$paisSession."'";
...
//  $handle = str_replace(',',';',$handle);
        while (($data = fgetcsv($handle, 100000, $selectedDelimiter)) !== FALSE) {
            ...
            $q = "INSERT INTO comisiones_adicional (pais, cod_ruta, desc_marca, formato, tipo_formato, valor, sistema) VALUES (
                '$data[0]',
                '$data[1]',
                '$data[2]',
                '$data[3]',
...
<div class="container">
    ...
    <div class="row">
        <div class="col-12 col-md-12">
            ...
            <?php
            $sqlSelect = "SELECT * FROM comisiones_adicional where pais = '".$paisSession."' ORDER BY cod_ruta,desc_marca";
