...
if (isset($_POST["delete"])) {
    $query = "DELETE FROM imperdonables_marcas WHERE pais = '".$paisSession."'";
...
//  $handle = str_replace(',',';',$handle);
        while (($data = fgetcsv($handle, 100000, $selectedDelimiter)) !== FALSE) {
            ...
            $q = "INSERT INTO imperdonables_marcas (pais, cod_ruta, marca, tipo_formato) VALUES (
                '$data[0]',
                '$data[1]',
                '$data[2]',
                '$data[3]'
...
<div class="container">
    ...
    <div class="row">
        <div class="col-12 col-md-12">
            ...
            <?php
            $sqlSelect = "SELECT * FROM imperdonables_marcas where pais = '".$paisSession."' ORDER BY cod_ruta";
