...
$active = "ecpresupuesto";
// conexión

if (isset($_POST["delete"])) {
    $query = "DELETE FROM alcance_presupuesto WHERE pais = '".$paisSession."'";
...
<div class="container">
    <div class="row align-items-start text-center">
        <div class="col">
            <h3 class="mt-3">Carga Plantilla EC Presupuestos</h3>
        </div>
        <div class="col">
                        ...
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="static/14_plantilla_ec_presupuesto.csv">Ec - Presupuesto</a></li>
                                </ul>
                            </div>
                        </div>
